...
void floor()
{
	...
	floor_colors[1] = vertex_colors[0]; floor_points[1] = vertices_floor[1];
	floor_colors[2] = vertex_colors[4]; floor_points[2] = vertices_floor[2];

	floor_colors[3] = vertex_colors[4]; floor_points[3] = vertices_floor[2];
	floor_colors[4] = vertex_colors[7]; floor_points[4] = vertices_floor[3];
