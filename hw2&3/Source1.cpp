...
void xyz_line()
{
	line_colors[0] = vertex_colors[1]; line_points[0] = point4(0, 0, 0, 1);
	line_colors[1] = vertex_colors[1]; line_points[1] = point4(10, 0, 0, 1);
	line_colors[2] = vertex_colors[1]; line_points[2] = point4(20, 0, 0, 1);

	line_colors[3] = vertex_colors[5]; line_points[3] = point4(0, 0, 0, 1);
	line_colors[4] = vertex_colors[5]; line_points[4] = point4(0, 10, 0, 1);
	line_colors[5] = vertex_colors[5]; line_points[5] = point4(0, 20, 0, 1);

	line_colors[6] = vertex_colors[4]; line_points[6] = point4(0, 0, 0, 1);
...
void init()
{
	...
	program_2 = InitShader("my_vshader.glsl", "my_fshader.glsl");
}
